...
namespace llgl {
class LLGLRendererRGB;
} // namespace llgl

class llgl::LLGLRendererRGB final
        : public allshader::WaveformRendererSignalBase,
          public rendergraph::GeometryNode {
  public:
    explicit LLGLRendererRGB(WaveformWidgetRenderer* waveformWidget,
  ...
  private:
    ...
    DISALLOW_COPY_AND_ASSIGN(LLGLRendererRGB);
};
